...
(1, 101, '123 Main St', '1234567'),
(2, 102, '456 Apple St', '9876543'),
(3, 103, '789 Merlin St', '4567890'),
(4, 104, '567 Walnut St', '1112222'),
(5, 105, '789 Cherry St', '3334444'),
(6, 106, '901 Pineapple St', '5555555');
SELECT * FROM Branch;
...
# 3.Retrieve the book titles and the corresponding customers who have issued those books.
 SELECT Issued_book_name AS Book_title, Customer_name FROM IssueStatus INNER JOIN Customer
...
SELECT Customer_name FROM Customer INNER JOIN IssueStatus ON Customer.Customer_Id = IssueStatus.Issued_cust
